                                                ...
                                                @case('actions')
                                                    <td class="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-0 text-white">
                                                        <div class="inline-block">
                                                            <a href="{{ route('users.show', ['id' => $row['id']]) }}" class="text-indigo-400 hover:text-indigo-300 mr-2">
                                                                <i class="fa-solid fa-eye"></i>
                                                            </a>
                                                        </div>
                                                        <div class="inline-block">
                                                            <a href="{{ route('users.edit', ['id' => $row['id']]) }}" class="text-indigo-400 hover:text-indigo-300 mr-2">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                        </div>
                                                        <div class="inline-block">
                                                            <a href="{{ route('users.destroy', ['id' => $row['id']]) }}" class="text-indigo-400 hover:text-red-500 mr-2">
                        ...
                        <div>
                            ...
                            <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm bg-gray-900 text-white" aria-label="Pagination">
                                ...
                                @if($pagination['jump_last'])
                                    <div class="relative inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-500 rounded inset-0 focus:z-20 focus:outline-offset-0">...</div>
                                    <div wire:click="changePage({{ $totalPages }})" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold hover:bg-gray-700 rounded inset-0 focus:z-20 focus:outline-offset-0 cursor-pointer">{{ $totalPages }}</div>
                                @endif
